...
.container {
    ...
    .pagelaran-img {
        ...
        position: absolute;
        top: 90%;
        transform: translate(-0%, -70%); /* Geser teks setengah dari lebar dan tinggi teks */
    }
