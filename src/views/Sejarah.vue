<template>
  <div id="sejarah">
    <div class="about">Sejarah</div>
    <div class="about-title">Keraton Kasepuhan Cirebon</div>
    <div class="galery">
        <img class="image-1" src="../assets/sejarah_img2-2.png">
        <img class="image-2" src="../assets/image 1.png">
        <img class="image-3" src="../assets/maharanita-nugradianti-MYBgf-opmo4-unsplash-2.png">
    </div>
    <div class="btn-info">
